...
namespace Shoop.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CustomerId,OrderDate,NrOfItems")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CustomerId,OrderDate,NrOfItems")] Order order)
        {
            if (ModelState.IsValid)
            {
